            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-file-image-o"></i> Banners <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="_cadastrar-banner.php">Cadastrar Banners</a></li>
                      <li><a href="_listar-banner.php">Listar Banners</a></li>
                    
                    </ul>
                  </li>
                  <li><a><i class="fa fa-users"></i> Alunos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="_cadastrar-aluno.php">Cadastrar Alunos</a></li>
                      <li><a href="_listar-aluno.php">Listar Alunos</a></li>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item"  href="_cadastrar-usuario.php"> Configuração</a>
